  ...
  return (
    <section className="mt-5 md:mt-[100px]" id="us-section">
      ...
      <Link href={`${locale}/contact`} className="">
        <button type="button" className="md:mt-[20px] text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-lg px-5 py-2.5 mr-5 mb-5 dark:bg-blue-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
